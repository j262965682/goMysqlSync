...
type Config struct {
	...
	DbDays       int                   `yaml:"db_days"` //db文件数据的保留时间  默认30天
	...
	// ------------------- MYSQL -----------------
	MysqlAddr      string `yaml:"mysql_addrs"`      //Mysql地址
	MysqlGroupType string `yaml:"mysql_group_type"` //集群类型 sentinel或者cluster
